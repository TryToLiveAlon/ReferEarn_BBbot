...
if (users === admin) {
  ...
  var BonusTime = Bot.getProperty("BonusTime")
  ...
  var buttons = [
    ...
    [
      {
        ...
        [
      {
        text: " 🕡 Set Time Interval For Bonus: " + BonusTime+" seconds",
        callback_data: "/setBonusTime"
      }
    ],
    [
      {
    ...
    [
       {
        text: "Private channel for admin ⬇️",
        callback_data: "/khffgjj"
       }
    ],
    [
       {
        text: "⚠️ Set withdrawl request channel : " + admin_approvechannel,
        callback_data: "/setWithdrawlChannel"
       }
    ]
  ]
